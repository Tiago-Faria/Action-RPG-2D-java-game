 ...
 * @author tiago
 */
public class PersonagemMago extends PersonagemModel{
    public float mana_max;
    public float mana;
    public float mana_regen;
    public PersonagemMago(Coordenada pos, EntidadeView view) {
        super(pos, view,32);
        super.dano = 40;
        super.setDefesa(20);
        super.hp_max = 200;
        ...
        this.inventario.adicionarItem(new ArmaMagoVarinha(5));
        this.inventario.adicionarItem(new ArmaMagoCajado(4));
        this.inventario.adicionarItem(new ArmaMagoLivro(0));
        this.inventario.adicionarItem(new PocaoCura());
        setMagiaQ(new HabilidadeBolaDeFogo());
    ...
    void uparNivel() {
        ...
        this.mana = mana_max;
        this.dano += 5;
        this.setDefesa(this.getDefesa() + 4);
    }
    @Override
    public void hook(){
        mana += mana_regen;
